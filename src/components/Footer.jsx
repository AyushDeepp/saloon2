      ...
      <div className="container footer-container">
        <div className="footer-brand">
          ...
          <p className="footer-desc">
            <a href={CONTACT_INFO.addressMapsUrl} target="_blank" rel="noopener noreferrer" style={{ color: 'inherit' }} className="contact-link-hover">
              {CONTACT_INFO.address}
            </a>. Premium Unisex Salon for Hair, Skin, Makeup & Grooming.
          </p>
          <div className="social-links">
            <a href={CONTACT_INFO.instagramUrl} target="_blank" rel="noopener noreferrer" aria-label="Instagram">
            ...
            <a href={CONTACT_INFO.whatsAppUrl} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
